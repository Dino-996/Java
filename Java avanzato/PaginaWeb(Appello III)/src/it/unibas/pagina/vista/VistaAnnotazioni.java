...
public class VistaAnnotazioni extends javax.swing.JDialog {
    ...
    public void aggiornaTabella() {
        ...
        //Senza formattazione le ore non venivano settate correttamente
        SimpleDateFormat annoCorrente = new SimpleDateFormat("yyyy");
        SimpleDateFormat meseCorrente = new SimpleDateFormat("MM");
        SimpleDateFormat giornoCorrente = new SimpleDateFormat("dd");
        SimpleDateFormat oreCorrenti = new SimpleDateFormat("HH");
        SimpleDateFormat minutiCorrenti = new SimpleDateFormat("mm");
        this.campoAnno.setText(annoCorrente.format(new Date()));
        this.campoMese.setText(meseCorrente.format(new Date()));
        this.campoGiorno.setText(giornoCorrente.format(new Date()));
        this.campoOre.setText(oreCorrenti.format(new Date()));
        this.campoMinuti.setText(minutiCorrenti.format(new Date()));
    ...
    public void inizializzaAzioni() {
        ...
        this.campoGiorno.setAction(Applicazione.getIstance().getCotrolloAnnotazione().getAzioneAggiungi());
        this.campoAnno.setAction(Applicazione.getIstance().getCotrolloAnnotazione().getAzioneAggiungi());
        this.campoMese.setAction(Applicazione.getIstance().getCotrolloAnnotazione().getAzioneAggiungi());
        this.campoMinuti.setAction(Applicazione.getIstance().getCotrolloAnnotazione().getAzioneAggiungi());
        this.campoOre.setAction(Applicazione.getIstance().getCotrolloAnnotazione().getAzioneAggiungi());
        this.campoParolaFine.setAction(Applicazione.getIstance().getCotrolloAnnotazione().getAzioneAggiungi());
        this.campoParolaInizio.setAction(Applicazione.getIstance().getCotrolloAnnotazione().getAzioneAggiungi());
    }
