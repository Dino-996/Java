...
public class ControlloAnnotazione {
    ...
    private class AggiungiAnnotazione extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (interoParolaInizio > paginaSelezionata.getNumeroParole() || interoParolaFine > paginaSelezionata.getNumeroParole()) {
            ...
            //PUNTO3 - Scenario alternativo - Dati scorretti
            if (interoParolaInizio > interoParolaFine) {
                Applicazione.getIstance().getFrame().getErrore("La parola iniziale non può essere successiva alla finale");
                return;
            }
