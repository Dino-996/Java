...
public class DAOArchivio implements IDAOArchivio {
    ...
    public Archivio carica(String file) throws DAOException {
        ...
        Aereomobile boeing = new Aereomobile("B12n", 660, Costanti.BOEING_747, new GregorianCalendar(2022, Calendar.JUNE, 18));
        Aereomobile airbus = new Aereomobile("A34u", 840, Costanti.AIRBUS_A380, new GregorianCalendar(2022, Calendar.JUNE, 28));
        Aereomobile ilyushin = new Aereomobile("I57s", 520, Costanti.ILYUSHIN_96, new GregorianCalendar(2022, Calendar.JUNE, 30));
