 ...
 * -Dit.unibas.utilita.LogLevel=<livello><br />
 * es: java -Dit.unibas.utilita.LogLevel=fine<br />
 ...
 * -Dit.unibas.utilita.LogFile=<nomeFile><br />
 * es: java -Dit.unibas.utilita.LogLevel=finer -Dit.unibas.utilita.LogFile=e:\tmp\log.txt<br />
 *
 * @author G. Mecca
 * @version 1.0
 */
public class Logger {
     ...
     * imposta il livello di logging utilizzando la proprieta' it.unibas.utilita.LogLeve
     * e sceglie il flusso su cui indirizzare il logging sulla base del valore della
     * proprieta' it.unibas.utilita.LogFile
     */
    static {
        logger = java.util.logging.Logger.getLogger("it.unibas.utilita");
    ...
    private static java.util.logging.Level selezionaLivello() {
        String livello = System.getProperty("it.unibas.utilita.LogLevel");
        logger.fine(livello);
        if (livello != null) {
    ...
    private static java.util.logging.Handler selezionaHandler(){
        ...
        String nomeFile = System.getProperty("it.unibas.utilita.LogFile");
